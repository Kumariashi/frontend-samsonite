...
const ProductIntelligentCenterIcon = (props) => {
    ...
    return(
        <svg className={`bi bi-box ${iconClass}`} width={iconWidth} height={iconHeight} fill={iconColor} viewBox="0 0 16 16">
...
export default ProductIntelligentCenterIcon;